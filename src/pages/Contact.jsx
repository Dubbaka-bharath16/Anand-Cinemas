...
const Contact = () => {
  ...
  const validationSchema = Yup.object({
    ...
    message: Yup.string().required('Please describe your vision')
  })
  ...
  const faqs = [
    {
      ...
      answer:
        'We produce feature films, documentaries, and web series that combine meaningful storytelling with commercial appeal. Our focus is on projects with strong narratives and social relevance.'
    },
    {
      question: 'How can I submit a script?',
      answer:
        'You can submit your project through our contact form. Please include a brief synopsis and your contact information. Our team reviews all submissions within 2-3 weeks.'
    },
    {
      question: 'Do you work with new filmmakers?',
      answer:
        'Yes, we welcome collaborations with both established and emerging filmmakers. We value fresh perspectives and compelling stories above all else.'
    },
    {
      question: 'What is your production timeline?',
      answer:
        'Timelines vary by project scope. Feature films typically take 12-18 months from development to completion, while shorter projects may take 3-6 months.'
    }
  ]
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          >
            ...
            >
              Your vision, our expertise. Let's bring your cinematic dreams to
              life.
            </motion.p>
          </motion.div>
        </div>
            ...
            >
              ...
              >
                ...
                <p className="text-gray-600 text-base md:text-lg">
                  Ready to bring your story to the screen? Share your vision
                  with us.
                </p>
              </motion.div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      <p className="text-sm font-medium text-green-800">
                        Thank you for your message! We'll review your project
                        ...
                        <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg flex items-center justify-center group-hover:from-blue-600 group-hover:to-blue-700 transition-all duration-300 text-white">
                          ...
                          {item.icon === 'clock' && (
                            <svg
                              ...
                              fill="currentColor"
                            >
                              <path d="M12 1a11 11 0 1011 11A11 11 0 0012 1zm1 12.59V7a1 1 0 10-2 0v6a1 1 0 00.46.84l4 2.5a1 1 0 10.97-1.72z" />
                            </svg>
                          )}
                        </div>
                      </motion.div>
            ...
            >
              <div className="p-4 md:p-6 text-center border-b border-gray-200">
                ...
                <p className="text-gray-600 text-sm md:text-base">
                  Film City Complex, Studio 7B, Mumbai, India 400053
                </p>
              </div>
