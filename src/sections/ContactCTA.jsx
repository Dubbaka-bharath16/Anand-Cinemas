...
const TESTIMONIALS = [
  {
    name: "Rohan Sharma",
    role: "Film Director",
    text: "Working with Anand Cinemaz was an exceptional experience. Their creative vision and attention to detail brought our project to life in ways we couldn't have imagined.",
  ...
  },
  {
    ...
    text: "The team demonstrated remarkable professionalism and artistic sensibility throughout our collaboration. They delivered outstanding results that exceeded our expectations.",
  ...
  },
  {
    ...
    text: "Anand Cinemaz combines technical expertise with creative excellence. Their innovative approach transformed our concept into a visually stunning production.",
  ...
  },
  {
    ...
    text: "From concept to completion, the team was collaborative, responsive, and deeply committed to quality. Their work speaks volumes about their dedication to cinematic excellence.",
  ...
  },
  {
    name: "Rajesh Kumar",
    role: "Studio Manager",
    text: "Their creative judgment and technical precision are remarkable. The final output not only met but significantly surpassed our project requirements.",
